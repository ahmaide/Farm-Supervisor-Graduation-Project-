...
public class SprayFarmersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_spray_farmers, container, false);
        farmersLayout = view.findViewById(R.id.sprayFarmersLayout);
    ...
    private void addSprayFarmers() {
        String email = sharedPrefManager.readString("email", "noValue");
        String addUrl = "http://" + IpAddress.VALUE + ":8080/api/v1/specialization/typeFarmers/spraying";
...
//            innerLayoutParams.setMargins(5, 5, 5, 5);
            ...
            farmerEmailTextView.setTextSize(TypedValue.COMPLEX_UNIT_SP, 20); // Set text size
...
//            serviceTextView.setGravity(Gravity.CENTER);
            ...
            farmerEmailTextView.setPadding(0, 0, textViewLeftPadding, 0);
...
//            innerLayoutParams.setMargins(15, 0, 15, 0);
            ...
            farmerPhoneTextView.setPadding(0, 0, textViewLeftPadding, 0);
            ...
            imageButton.setImageResource(R.drawable.pesticide2);
