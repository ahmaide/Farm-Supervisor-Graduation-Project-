...
public class PruningFarmersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_pruning_farmers, container, false);
        farmersLayout = view.findViewById(R.id.pruningFarmersLayout);
    ...
    private void addPruningFarmers() {
        String email = sharedPrefManager.readString("email", "noValue");
        String addUrl = "http://" + IpAddress.VALUE + ":8080/api/v1/specialization/typeFarmers/pruning";
...
//            innerLayoutParams.setMargins(15, 0, 15, 0);
            ...
            imageButton.setImageResource(R.drawable.pruning_shears2);
